...
| :--- | :--- | :---: |
| **Cường (Lead)** | - [ ] Tạo repo, mời đủ thành viên, phân nhánh Git<br>- [ ] Chạy thành công `run_phase1.py` và `run_corruption_flow.py`<br>- [ ] Hoàn thành `report/group_report.md` và `docs/TEAM.md`<br>- [ ] Xác nhận 100% thành viên có commit trên GitHub nhánh `main`<br>- [ ] Nộp link repo lên VLearn LMS bằng tài khoản cá nhân | 🔲 |
| **Hoàng (Data)** | - [ ] Hoàn thành `crossref.py` (có fallback offline)<br>- [ ] Hoàn thành `cleaning.py` (tính `age_days`, `text_for_embedding`)<br>- [ ] Hoàn thành `corruption.py` (đủ 6 kịch bản lỗi)<br>- [ ] Hoàn thành file báo cáo cá nhân `report/<MSSV2>_HoTen.md`<br>- [ ] Có commit trên nhánh `main` và nộp link LMS cá nhân | 🔲 |
| **Khánh (RAG)** | - [ ] Quản lý 3 collection ChromaDB tách biệt rõ ràng<br>- [ ] Tối ưu QA Agent trả lời dựa trên context<br>- [ ] Đo lường độ sụt giảm của Retrieval Hit Rate khi dữ liệu bị lỗi<br>- [ ] Hoàn thành file báo cáo cá nhân `report/<MSSV3>_HoTen.md`<br>- [ ] Có commit trên nhánh `main` và nộp link LMS cá nhân | 🔲 |
| **Trang (Eval)** | - [ ] Dựng xong Great Expectations 1.x chuẩn (ephemeral mode, 4 expectations)<br>- [ ] Hoàn thành Freshness SLA (cảnh báo `age_days > 180`)<br>- [ ] Sinh file `test_set.json` đủ 10 câu hỏi qua 4 nhóm nghiệp vụ<br>- [ ] Xuất file báo cáo `corruption_report.md` đủ 3 cột đối chiếu<br>- [ ] Hoàn thành file báo cáo cá nhân `report/<MSSV4>_HoTen.md`<br>- [ ] Có commit trên nhánh `main` và nộp link LMS cá nhân | 🔲 |
